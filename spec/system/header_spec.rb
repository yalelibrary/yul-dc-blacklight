...
RSpec.describe 'header', type: :system do
  ...
  it 'has expected links on the main header' do
    expect(page).to have_link('Saved Items', href: '/bookmarks')
  ...
  it 'has expected links in the submenu' do
    expect(page).to have_link('Search Quicksearch', href: 'http://search.library.yale.edu')
    expect(page).to have_link('Search Library Catalog', href: 'https://search.library.yale.edu/catalog')
    expect(page).to have_link('Search Digital Collections', href: 'https://library.yale.edu/explore-collections/explore/digital-collections')
    ...
    expect(page).to have_link('Request Digital Copies of Special Collections', href: 'https://library.yale.edu/find-request-and-use/use/using-special-collections/request-digitization')
    ...
    expect(page).to have_link('Bass Library', href: 'https://library.yale.edu/bass')
    expect(page).to have_link('Beinecke Library', href: 'https://beinecke.library.yale.edu/')
    expect(page).to have_link('Classics Library', href: 'https://library.yale.edu/classics')
    expect(page).to have_link('Divinity Library', href: 'https://library.yale.edu/divinity')
    expect(page).to have_link('Yale Film Archive', href: 'https://library.yale.edu/film')
    expect(page).to have_link('Fortunoff Archive', href: 'https://fortunoff.library.yale.edu/')
    ...
    expect(page).to have_link('Law Library', href: 'https://library.law.yale.edu/')
    expect(page).to have_link('Lewis Walpole Library', href: 'https://walpole.library.yale.edu/')
    ...
    expect(page).to have_link('Marx Science & Social Science Library', href: 'https://library.yale.edu/marx')
    expect(page).to have_link('Medical Library', href: 'https://library.medicine.yale.edu/')
    expect(page).to have_link('Music Library', href: 'https://library.yale.edu/visit-and-study/libraries-locations/irving-s-gilmore-music-library')
    expect(page).to have_link('Sterling Library', href: 'https://web.library.yale.edu/building/sterling-memorial-library')
    expect(page).to have_link('Yale Center for British Art', href: 'https://britishart.yale.edu/')
